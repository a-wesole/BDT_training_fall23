...
#SBATCH -t 4:00:00
#SBATCH --mem=2400MB
#SBATCH --job-name=data830_${STARTFILE}to${ENDFILE}_${JobIndex}
#SBATCH -o /home/awesole/party/logFiles/SBATCH_${STARTFILE}to${ENDFILE}_${JobIndex}.log
#SBATCH -e /home/awesole/party/logFiles/SBATCH_${STARTFILE}to${ENDFILE}_${JobIndex}.err
#SBATCH --no-requeue
#SBATCH --export=ALL
#SBATCH -A standby
