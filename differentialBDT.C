...
int differentialBDT(TString inputfile="", TString outfile1="")
{
	...
	if(istest)
	{
		...
		outfile1 = "/scratch/brown/awesole/test.root";
...
//	float nmass[max_size], npT[max_size], ny[max_size], n3DDecayLengthSignificance[max_size], nVtxProb[max_size],n3DPointingAngle[max_size],nDtrk1Pt[max_size],nDtrk2Pt[max_size],nDtrk1PtErr[max_size],nDtrk2PtErr[max_size],nDtrk1Chi2n[max_size],nDtrk2Chi2n[max_size], nxyDCASigD1[max_size], nxyDCASigD2[max_size], nzDCASigD1[max_size], nzDCASigD2[max_size], log3ddls[max_size];
	...
	*/
	...
	mvaTree->Branch("Dtrk1PtErr", Dtrk1PtErr,"Dtrk1PtErr[Dsize]/F");
	mvaTree->Branch("Dtrk2PtErr", Dtrk2PtErr,"Dtrk2PtErr[Dsize]/F");
	mvaTree->Branch("Dtrk1Chi2n", Dtrk1Chi2n,"Dtrk1Chi2n[Dsize]/F");
	mvaTree->Branch("Dtrk2Chi2n", Dtrk2Chi2n,"Dtrk2Chi2n[Dsize]/F"); 

	mvaTree->Branch("x3DDecayLengthSignificance", x3DDecayLengthSignificance, "x3DDecayLengthSignificance[Dsize]/F");
	mvaTree->Branch("VtxProb",VtxProb , "VtxProb[Dsize]/F");
	mvaTree->Branch("x3DPointingAngle", x3DPointingAngle,"x3DPointingAngle[Dsize]/F");
	mvaTree->Branch("Dtrk1Pt", Dtrk1Pt,"Dtrk1Pt[Dsize]/F");
	mvaTree->Branch("Dtrk2Pt", Dtrk2Pt,"Dtrk2Pt[Dsize]/F");
	...
	//mvaTree->Branch("log3ddls", log3ddls, "log3ddls[Dsize]/F");
